...
C 
C 01/29/2008 -- bkoo (ENVIRON) - removed hard coded info
C 09/16/2012 -- tlroche (AMAD) - removed EDGAR-specific code, genericized
...
!         FDESC3D(2) = 'Converted to I/O API format by MOZART2CMAQ'
         FDESC3D(2) = 'Converted to I/O API format by netcdf2ioapi'
